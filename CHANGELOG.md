...
- `update_and_log` / `log_changes` no longer raise `Ecto.ConstraintError` on audit_log pkey unique violation; declare `unique_constraint` so violations become soft errors. Closes OPS-4576.
