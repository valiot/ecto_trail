...
- `update_and_log` / `log_changes` now registers `unique_constraint/3` for `audit_logs_pkey` (configurable table), preventing Ecto.ConstraintError on duplicate audit log PK. Closes OPS-4614.
