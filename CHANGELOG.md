...
- `*_and_log/*` no longer raise Ecto.ConstraintError on `audit_logs_pkey` (unique_constraint) during audit log insert inside the tx. Added `unique_constraint(:id, name: "<table>_pkey")` to the internal changelog changeset. Closes OPS-4577.
