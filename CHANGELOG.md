...
- Declare `unique_constraint/3` on audit log changeset for common pkey names (`audit_logs_pkey` etc.) so duplicate PK inserts yield changeset errors instead of `Ecto.ConstraintError`. Closes OPS-4609.
