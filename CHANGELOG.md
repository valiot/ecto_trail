...
- `log_changes`/`update_and_log` (and siblings) no longer raise on Ecto.ConstraintError for audit_log pkey (or similar unique constraints); treated as idempotent "already recorded". Closes OPS-4582.
